...
document.getElementById("btn1").addEventListener("click",function(){
    ...
    // 4) 중간에 존재하는 자식 탐색 : 부모요소.childNodes[인덱스]
    ...
    console.log(nodeList[8].previousSibling.previousSibling);
...
document.getElementById("btn2").addEventListener("click",function(){
    ...
    // #test의 첫번째 자식 요소 
    document.getElementById("test").firstElementChild.style.backgroudColor="red";

    // # test의 자식 중 2번 인덱스의 이전 형제 요소 배경색 yellowgreen으로 변경
    list[2].previousElementSibling.style.backgroudColor="yellowgreen";
...
document.getElementById("btn3").addEventListener("click",function(){
    ...
    //document.creatElement("태그명") : 해당 태그 요소를 생성하여 반환
    const child = document.createElement("div"); // div 생성 0, 화면 배치x
