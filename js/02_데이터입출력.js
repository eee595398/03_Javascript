...
function getInnerText(){
    ...
    // HTML 문서내에서 아이디가 "test1"인 요소를 얻어와
    // test1 변수에 대입
...
function setInnerHTML1(){
    ...
    test2.innerHTML="<b>innerHTML로 변경된 내용</b> <br> 안녀"
...
function add(){
    ...
    //1) 아이디가 area1인 요소 엾어오기
    const area1 = document.getElementyById("area1");

    //2) area1에 <div class="box2"> 누적 대입
